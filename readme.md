...
#### A model of a banking web application with the main working services (BackEnd part) connected to the MySQL database.

#### Tables processed: customers, accounts, products, agreements, transactions and managers.
___
___
## Database structure
